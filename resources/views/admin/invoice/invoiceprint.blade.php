...
<div class="container-fluid mt-3 mb-3">
    <div class="card shadow-sm p-3 mx-auto" style="max-width: 650px; font-family: Arial, sans-serif;">
        
        <!-- Header -->
        <div class="text-center mb-3">
            <h3 class="mb-0">SOFAHUB</h3>
            <small>Admin Invoice Receipt</small><br>
            <strong>#{{ str_pad($sale->id, 6, '0', STR_PAD_LEFT) }}</strong>
        </div>

        <!-- Buttons -->
        <div class="d-flex justify-content-between mb-2 no-print">
            <a href="{{ url('admin/invoice') }}" class="btn btn-sm btn-primary">
        ...
        <div class="text-center mt-3">
            <small class="text-muted">
                Generated by Admin Panel • {{ now()->format('M d, Y h:i A') }}
            </small>
        </div>
    </div>
